<html>
    ...
    <body>
        ...
        <br><br><br><br><br><font size="5" ><h1> <span class="abc" >               <a href="Student (2).jsp" target ="_blank" >Student Info</a>       <a href="marks.html"target ="_blank" >Marks</a>       <a href="Attendence.jsp" target=_blank>Attendence</a>       <a href="table.html">Time Table</a></font></h1></span>
    <div class="im">
