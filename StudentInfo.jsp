...
<html>
    ...
    <body>
        ...
        <div class="bo l">
            <center>Student Info.</center></div>

        <table  align='center' width="900px" class="j">
            <tr>
                <th align="left" colspan="10" height="40px">Student Details:</th>
               <th><form action="addUpdate.jsp" > <button type="submit"  class="button button4"><b>Insert</b></button></form></th>   <th><button onclick="myFunction()" class="button button4"><b>Print</b></button></th>
            </tr>
            <tr>
                <td height="35px"> First Name</td>
                <td >Last Name</td>
                <td >Roll no</td>
                <td >Gender</td>
                <td >Date oF Birth</td>
            ...
            <%for (StudentBeans i : list) {%>
            <tr class="s">
                <td height="35px"><%=i.getFirstName()%></td>
                <td><%=i.getLastName()%></td>
                <td><%=i.getRollNo()%></td>
                <td><%=i.getGender()%></td>
